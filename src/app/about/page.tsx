...
export default function AboutPage() {
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 py-16 px-6 items-center">
        ...
        <div className="flex flex-col items-start justify-center gap-2">
          ...
          <button className="relative group">
            ...
            {/* button */}
            <span className="relative bg-gray-200 text-black px-8 py-3 font-medium block
  transition-transform group-hover:translate-x-1 group-hover:translate-y-1">
      ...
      {/* WHY CHOOSE US */}
      <section className="max-w-6xl mx-auto py-20 px-6 min-h-screen">
        ...
        <p className="text-center text-gray-600 mb-14 max-w-xl mx-auto">
          Stonie menghadirkan material batu berkualitas tinggi
          dengan proses penambangan yang bertanggung jawab dan
          standar keamanan industri yang ketat.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-end">
          ...
          <div className="flex flex-col items-start justify-start space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <p>
                Seluruh aktivitas penambangan kami telah melalui
                proses perizinan resmi dan diawasi oleh lembaga
                pemerintah terkait.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <div className="w-9 h-5 bg-gray-400 rounded-full mt-2"></div>
              <p>
                Material batu dipilih langsung dari sumber terbaik
                sehingga memiliki kekuatan, ketahanan, dan kualitas
                yang konsisten.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <div className="w-9 h-5 bg-gray-400 rounded-full mt-2"></div>
              <p>
                Kami menerapkan standar keamanan kerja yang tinggi
                untuk memastikan proses produksi berjalan aman
                dan berkelanjutan.
              </p>
            </div>
