...
export default function AboutPage() {
  ...
  return (
    <main className="bg-gray-100 text-gray-900 pt-20">
      {/* HERO */}
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 py-16 px-6 items-center responsive-section">
      ...
      {/* WHY CHOOSE US */}
      <section id="2" className="max-w-6xl mx-auto py-20 px-6 min-h-screen responsive-section">
